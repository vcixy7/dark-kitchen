// Seeder ADITIVO e SEGURO: adiciona os pratos da categoria APENAS aos
// restaurantes que ainda não têm nenhum produto. Não apaga nada e não
// duplica os 50 restaurantes que já estão com 8 pratos cada.
...
const produtosPorCategoria = {
  brasileira: [
    ...
    { nome: 'Arroz com Feijão', descricao: 'Acompanhamento tradicional', preco: 12.90, imagem: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?q=80&w=500', categoria: 'Acompanhamentos' },
    ...
    { nome: 'Farofa de Couve', descricao: 'Farofa temperada com couve', preco: 7.90, imagem: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?q=80&w=500', categoria: 'Acompanhamentos' },
    ...
    { nome: 'Pudim de Leite', descricao: 'Pudim tradicional', preco: 9.90, imagem: 'https://images.unsplash.com/photo-1578985545062-69928b1d9587?q=80&w=500', categoria: 'Sobremesas' }
  ],
  pizzaria: [
    ...
    { nome: 'Pizza Pepperoni', descricao: 'Com pepperoni crocante', preco: 47.90, imagem: 'https://images.unsplash.com/photo-1513104890138-7c749659a591?q=80&w=500', categoria: 'Pizzas' },
    { nome: 'Pizza Quatro Queijos', descricao: 'Mussarela, gorgonzola, parmesão e provolone', preco: 52.90, imagem: 'https://images.unsplash.com/photo-1513104890138-7c749659a591?q=80&w=500', categoria: 'Pizzas' },
    ...
    { nome: 'Batata Recheada', descricao: 'Batata com queijo derretido', preco: 14.90, imagem: 'https://images.unsplash.com/photo-1585521537529-d95bc2f4b6e0?q=80&w=500', categoria: 'Acompanhamentos' },
    ...
    { nome: 'Panna Cotta', descricao: 'Creme italiano delicado', preco: 11.90, imagem: 'https://images.unsplash.com/photo-1578985545062-69928b1d9587?q=80&w=500', categoria: 'Sobremesas' }
  ],
  hamburgueria: [
    ...
    { nome: 'Refrigerante Lata', descricao: 'Gelado', preco: 5.90, imagem: 'https://images.unsplash.com/photo-1554866585-f39d15e82500?q=80&w=500', categoria: 'Bebidas' }
  ],
  japonesa: [
    ...
    { nome: 'Hot Roll', descricao: 'Roll quente com frango', preco: 32.90, imagem: 'https://images.unsplash.com/photo-1579871494447-9811cf80d66c?q=80&w=500', categoria: 'Sushis' },
    ...
    { nome: 'Gyoza', descricao: '8 unidades fritas', preco: 18.90, imagem: 'https://images.unsplash.com/photo-1562565652-a0d3f7d7eb69?q=80&w=500', categoria: 'Acompanhamentos' },
    ...
    { nome: 'Chá Gelado', descricao: 'Chá verde gelado', preco: 6.90, imagem: 'https://images.unsplash.com/photo-1544432415-e28219cd816f?q=80&w=500', categoria: 'Bebidas' }
  ],
  italiana: [
    ...
    { nome: 'Ravioli ao Funghi', descricao: 'Recheio de ricota e funghi', preco: 41.90, imagem: 'https://images.unsplash.com/photo-1621996346565-e3dbc646d9a9?q=80&w=500', categoria: 'Pratos Principais' },
    { nome: 'Pesto alla Genovese', descricao: 'Molho verde tradicional', preco: 36.90, imagem: 'https://images.unsplash.com/photo-1621996346565-e3dbc646d9a9?q=80&w=500', categoria: 'Pratos Principais' },
    ...
    { nome: 'Bruschetta', descricao: 'Pão com tomate e manjericão', preco: 14.90, imagem: 'https://images.unsplash.com/photo-1585521537529-d95bc2f4b6e0?q=80&w=500', categoria: 'Acompanhamentos' },
    { nome: 'Tiramisu', descricao: 'Sobremesa clássica italiana', preco: 12.90, imagem: 'https://images.unsplash.com/photo-1571115177098-24ec42ed204d?q=80&w=500', categoria: 'Sobremesas' },
  ...
  tailandesa: [
    ...
    { nome: 'Green Curry', descricao: 'Curry verde com leite de coco', preco: 38.90, imagem: 'https://images.unsplash.com/photo-1455619452474-d2be8b1e4e31?q=80&w=500', categoria: 'Pratos Principais' },
    ...
    { nome: 'Salada Thai', descricao: 'Salada picante tailandesa', preco: 22.90, imagem: 'https://images.unsplash.com/photo-1540189549336-e6e99c3679fe?q=80&w=500', categoria: 'Saladas' },
    ...
    { nome: 'Chá Gelado Tailandês', descricao: 'Chá doce gelado', preco: 7.90, imagem: 'https://images.unsplash.com/photo-1544432415-e28219cd816f?q=80&w=500', categoria: 'Bebidas' }
  ],
  coreana: [
    ...
    { nome: 'Bulgogi', descricao: 'Carne marinada e grelhada', preco: 42.90, imagem: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?q=80&w=500', categoria: 'Carnes' },
    ...
    { nome: 'Tteokbokki', descricao: 'Bolinhos de arroz apimentado', preco: 16.90, imagem: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?q=80&w=500', categoria: 'Acompanhamentos' },
    ...
    { nome: 'Suco de Mirtilo', descricao: 'Bebida refrescante', preco: 8.90, imagem: 'https://images.unsplash.com/photo-1544432415-e28219cd816f?q=80&w=500', categoria: 'Bebidas' }
  ],
  mexicana: [
    ...
    { nome: 'Tacos Al Pastor', descricao: '4 tacos com carne marinada', preco: 28.90, imagem: 'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?q=80&w=500', categoria: 'Pratos Principais' },
    ...
    { nome: 'Arroz e Feijão', descricao: 'Acompanhamento tradicional', preco: 9.90, imagem: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?q=80&w=500', categoria: 'Acompanhamentos' },
  ...
  indiana: [
    ...
    { nome: 'Butter Chicken', descricao: 'Frango em molho de manteiga', preco: 40.90, imagem: 'https://images.unsplash.com/photo-1596040436409-fe3d97d5a5c3?q=80&w=500', categoria: 'Carnes' },
  ...
  vegetariana: [
    { nome: 'Bowl Buddha', descricao: 'Salada com grãos e legumes', preco: 34.90, imagem: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?q=80&w=500', categoria: 'Saladas' },
    ...
    { nome: 'Hambúrguer de Grão de Bico', descricao: 'Vegetariano e saudável', preco: 26.90, imagem: 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?q=80&w=500', categoria: 'Hambúrgueres' },
    { nome: 'Salada Caprese', descricao: 'Tomate, mussarela e manjericão', preco: 22.90, imagem: 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?q=80&w=500', categoria: 'Saladas' },
    ...
    { nome: 'Suco Verde Natural', descricao: 'Detox de maçã e cenoura', preco: 11.90, imagem: 'https://images.unsplash.com/photo-1544432415-e28219cd816f?q=80&w=500', categoria: 'Bebidas' }
  ]
};

(async () => {
  const restSnap = await getDocs(query(collection(db, 'users'), where('tipo', '==', 'restaurante')));

  // Conta produtos existentes por restaurante
  const prodSnap = await getDocs(collection(db, 'produtos'));
  const porRest = {};
  prodSnap.docs.forEach(d => {
    const rid = d.data().restauranteId;
    if (rid) porRest[rid] = (porRest[rid] || 0) + 1;
  });
  ...
  for (const docSnap of restSnap.docs) {
    ...
    const id = docSnap.id;
    if (porRest[id]) {
      continue; // já tem produtos, não mexe
    }

    const produtos = produtosPorCategoria[restaurante.categoria] || produtosPorCategoria['brasileira'];
    let i = 0;
    ...
    console.log(`✓ ${restaurante.nomeRestaurante} (${restaurante.categoria}): +${produtos.length} pratos`);
  }

  console.log(`\nTOTAL_PRATOS_CRIADOS=${totalCriado}`);
  process.exit(0);
